...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            $('#edu-data-table').DataTable({
                ...
                bInfo: false,
                bAutoWidth: false,
                ajax: "{{ route('admin.json.notification') }}",
                columns: [
                    {
                        data: 'count',
    ...
    <script>
        $(document).on('submit', '#eduForm', function (e) {
            ...
            var myUrl = "{{ route('admin.store.notification') }}";
    ...
    <script>
        $(document).on("click", ".btn-edit-row", function (e) {
            ...
            var tempEditUrl = "{{ route('admin.edit.notification', ':id') }}";
    ...
    <script>
        $(document).on('submit', '#eduFormUpdate', function (e) {
            ...
            var myUrl = "{{ route('admin.update.notification') }}";
    ...
    <script>
        $(document).on('click', '.btn-delete-row', function (e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var tempDeleteUrl = "{{ route('admin.delete.notification', ':id') }}";
    ...
    <script>
        $('input[name="pusher"]').on('change',function(){
            console.log('pusher');
            var pusher = $("input[name='pusher']:checked").val();
            if(pusher  == 0){
