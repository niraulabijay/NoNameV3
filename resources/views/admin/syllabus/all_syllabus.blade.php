...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            $('#edu-data-table').DataTable({
                ...
                bInfo: false,
                bAutoWidth: false,
                ajax: "{{ route('admin.json.syllabus') }}",
                columns: [
                    {
                        data: 'count',
    ...
    <script>
        $(document).on('submit', '#eduForm', function (e) {
            ...
            var myUrl = "{{ route('admin.store.syllabus') }}";
    ...
    <script>
        $(document).on("click", ".btn-edit-row", function (e) {
            ...
            var tempEditUrl = "{{ route('admin.edit.syllabus', ':id') }}";
    ...
    <script>
        $(document).on('submit', '#eduFormUpdate', function (e) {
            ...
            var myUrl = "{{ route('admin.update.syllabus') }}";
    ...
    <script>
        $(document).on('click', '.btn-chnage-status', function (e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var tempDeleteUrl = "{{ route('admin.changestatus.syllabus', ':id') }}";
    ...
    <script>
        $(document).on("change", ".selectforchild", function (e) {
            ...
            var tempResponseUrl = "{{ route('admin.change.syllabuscontent') }}";
