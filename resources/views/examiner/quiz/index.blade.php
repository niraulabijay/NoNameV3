...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            $('#edu-data-table').DataTable({
                ...
                bInfo: false,
                bAutoWidth: false,
                ajax: "{{ route('examiner.json.examinerQuiz') }}",
                columns: [
                    {
                        data: 'count',
    ...
    <script>
        $(document).on('submit', '#eduForm', function (e) {
            ...
            var myUrl = "{{ route('examiner.store.quiz') }}";
    ...
    <script>
        $(document).on("click", ".btn-edit-row", function (e) {
            ...
            var tempEditUrl = "{{ route('examiner.edit.quiz', ':id') }}";
    ...
    <script>
        $(document).on('submit', '#eduFormUpdate', function (e) {
            ...
            var myUrl = "{{ route('examiner.update.quiz') }}";
    ...
    <script>
        $(document).on('click', '.btn-chnage-status', function (e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var tempDeleteUrl = "{{ route('examiner.changestatus.quiz', ':id') }}";
    ...
    <script>
        $(document).on('click', '.btn-delete-row', function (e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var tempDeleteUrl = "{{ route('examiner.delete.quiz', ':id') }}";
            tempDeleteUrl = tempDeleteUrl.replace(':id', id);
...
<script>
    $(document).on("change", ".selectforchild", function (e) {
        ...
        var tempResponseUrl = "{{ route('examiner.change.examinerQuizContent') }}";
