...
<head>
    ...
    <link href="{{ asset('examiner_dash/assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">

    <link href="{{ asset('admin/assets/plugins/summernote/summernote-bs4.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin/assets/css/icons.css') }}" rel="stylesheet" type="text/css">

    <link href="{{ asset('examiner_dash/assets/css/style.css') }}" rel="stylesheet" type="text/css">
...
<div id="wrapper">
    ...
    @include('examiner.layouts.sidebar')
